...
# allplanes,VwPlane1000,FVwPlane1000 = Tesi.findallplane(V,FV,0.05,1000,2)
...
# allplanes,myV1,myFV1 = Tesi.findallplane(VwPlane1000,FVwPlane1000,0.05,500,2)
# meshes = [GL.GLGrid(allplanes[1][i],allplanes[2][i]) for i in 1:length(allplanes[1])]
# GL.VIEW([
#  	colorview(V,VV,rgb),
#  	meshes...,
...
function quadricshape(V::Lar.Points,FV::Lar.Cells,par::Float64,NOTASHAPE=10::Int64)
	...
	idxneighbors = Tesi.findnearestof(idxp,visitedverts,adj)
	tot=hcat(pointsoncyl,V[:,idxneighbors])
	idxp=vcat(idxp,idxneighbors)
	params = Tesi.cylinderfit(tot) #il primo non posso farlo solo su 3 punti  e forse bisogna cambiare idea generale
	visitedverts = copy(idxp)
	idxneighbors = Tesi.findnearestof(idxp,visitedverts,adj)
    ...
    while !isempty(idxneighbors)
	    ...
	    for i in idxneighbors
            ...
            if Tesi.ispointincyl(p,params,par)
				push!(idxp,i)
            end
		...
		pointsoncyl = V[:,idxp]
		@show size(pointsoncyl,2)
		params = Tesi.cylinderfit(pointsoncyl)
        idxneighbors = Tesi.findnearestof(idxp,visitedverts,adj)
    end
...
Vcyl, FVcyl = Tesi.larmodelcyl(params...)([36,36])
#myV,myFV,myrgb = Tesi.modelremained(V,FV,rgb,pointsoncyl)
...
# Vcyl1, FVcyl1 = Tesi.larmodelcyl(params...)([36,36])
# myV1,myFV1,myrgb1 = Tesi.modelremained(myV,myFV,myrgb,pointsoncyl)
#
# pointsoncyl,params = quadricshape(myV1,myFV1,0.02,40)
# Vcyl2, FVcyl2 = Tesi.larmodelcyl(params...)([36,36])
# myV2,myFV2,myrgb2 = Tesi.modelremained(myV1,myFV1,myrgb1,pointsoncyl)
#
# pointsoncyl,params = quadricshape(myV2,myFV2,0.02,40)
# Vcyl3, FVcyl3 = Tesi.larmodelcyl(params...)([10,10])
# myV3,myFV3,myrgb3 = Tesi.modelremained(myV2,myFV2,myrgb2,pointsoncyl)
#
# pointsoncyl,params = quadricshape(myV3,myFV3,0.02,40)
# Vcyl4, FVcyl4 = Tesi.larmodelcyl(params...)([10,36])
# myV4,myFV4,myrgb4 = Tesi.modelremained(myV3,myFV3,myrgb3,pointsoncyl)
#
# pointsoncyl,params = quadricshape(myV4,myFV4,0.02,40)
# Vcyl5, FVcyl5 = Tesi.larmodelcyl(params...)([10,36])
# myV5,myFV5,myrgb5 = Tesi.modelremained(myV4,myFV4,myrgb4,pointsoncyl)
#
# pointsoncyl,params = quadricshape(myV5,myFV5,0.01,40)
# Vcyl6, FVcyl6 = Tesi.larmodelcyl(params...)([10,36])
# myV6,myFV6,myrgb6 = Tesi.modelremained(myV5,myFV5,myrgb5,pointsoncyl)
#
# pointsonplane,params = Tesi.planeshape(myV6,myFV6,0.03,500)
# Vplane, FVplane = Tesi.larmodelplane(pointsonplane,params)
# myV7,myFV7,myrgb7 = Tesi.modelremained(myV6,myFV6,myrgb6,pointsonplane)
#
# pointsoncyl,params = quadricshape(myV7,myFV7,0.005,40)
# Vcyl7, FVcyl7 = Tesi.larmodelcyl(params...)([10,36])
# myV7,myFV7,myrgb7 = Tesi.modelremained(myV7,myFV7,myrgb7,pointsoncyl)
#
# pointsonplane,params = Tesi.planeshape(myV7,myFV7,0.02,100)
# Vplane1, FVplane1 = Tesi.larmodelplane(pointsonplane,params)
# myV8,myFV8,myrgb8 = Tesi.modelremained(myV7,myFV7,myrgb7,pointsonplane)
#
# GL.VIEW([
